(function() {
    ...
    // ==========================================
    // 1. قاعدة البيانات (عدّل هذا القسم: أضف موادك ومصادرها)
    //    لكل مادة انسخ الكتلة التالية داخل القوسين [ ] وعدّل البيانات:
    //    {
    //        subject: "اسم المادة",
    //        details: "تفاصيل المراجع (تظهر في عمود المراجع)",
    //        link: "https://رابط-المصدر"
    //    }
    // ==========================================
    const driveSources = [
        {
